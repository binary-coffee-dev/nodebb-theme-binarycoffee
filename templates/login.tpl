...
<!--						<div class="col-lg-10">-->
<!--							<input class="form-control" type="password" placeholder="[[user:password]]" name="password" id="password" &lt;!&ndash; IF username &ndash;&gt;autocomplete="off"&lt;!&ndash; ENDIF username &ndash;&gt;/>-->
